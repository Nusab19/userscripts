...
(function() {
    ...
    function blockAllSuggestionEvents() {
        ...
        const blockEvents = ['mouseover', 'mouseenter', 'mousemove', 'mousedown', 'click'];
        ...
        const suggestions = suggestionsContainer.querySelectorAll('.ytSuggestionComponentSuggestion');
        suggestions.forEach(suggestion => {
            blockEvents.forEach(eventType => {
                suggestion.addEventListener(eventType, function(e) {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    e.preventDefault();
                }, true);
    ...
    function fixSearchInput() {
        const searchInput = document.querySelector('input.ytSearchboxComponentInput[name="search_query"]');
        ...
        searchInput.addEventListener('keydown', function(e) {
            if (e.key === 'Enter') {
                ...
                if (searchValue) {
                    ...
                    if (form) {
                        window.location.href = form.action + '?search_query=' + encodeURIComponent(searchValue);
                    }
                }
            }
        }, true);
