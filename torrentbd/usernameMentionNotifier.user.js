...
(function () {
  ...
  function startMonitoring() {
    ...
    if (targetElement) {
      ...
      console.log(
        'Started monitoring DOM changes on element with id="shouts-container"',
      );
    } else {
      console.log(
        'Element with id="shouts-container" not found. Monitoring will start when element is available.',
      );
      ...
      const checkForElement = setInterval(() => {
        ...
        if (element) {
          ...
          console.log(
            'Element found! Started monitoring DOM changes on id="shouts-container"',
          );
